...
// Query de GET /api/v1/alerts (consolidé). `country` optionnel : absent →
// consolidation des trois pays. `type`/`acknowledged` relayés aux pays. La
// pagination s'applique sur l'ensemble fusionné, trié `triggeredAt` desc.
